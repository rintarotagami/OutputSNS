...
const Navigation = () => {
    return (
        <div className="top-0 left-0 h-screen w-64 bg-white bg-opacity-50 z-10 overflow-auto">
            <div className="p-8">
                <ul className="text-lg">
                    <li className="mb-4 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" className="mr-2"><path fill="currentColor" d="M6 19h3v-6h6v6h3v-9l-6-4.5L6 10zm-2 2V9l8-6l8 6v12h-7v-6h-2v6zm8-8.75"/></svg>
                    ...
                    <li className="mb-4 flex items-center">
                        ...
                        <span className="ml-2">後で解く問題</span>
                    </li>
                    <li className="mb-4 flex items-center">
                        ...
                        <span className="ml-2">フォローしている人</span>
                    </li>
                </ul>
                <ul className="text-lg border-t border-gray-200 mt-4 py-5">
                    <li className="mb-4"><span className="ml-2">マイページ ＞</span></li>
                    <li className="mb-4 flex items-center">
                    ...
                    <li className="mb-4 flex items-center">
                        ...
                        <span className="ml-2">プレイリスト</span>
                    </li>
                    <li className="mb-4 flex items-center">
                        ...
                        <span className="ml-2">高く評価した問題</span>
                    </li>
                </ul>
            </div>
        </div>
